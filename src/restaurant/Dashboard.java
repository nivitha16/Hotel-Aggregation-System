...
public abstract class Dashboard {
	...
	public void init(String userName) {
		...
		frame.add(setSidePanel(), gc);
		
		
		gc.gridx = 1;
		gc.weightx=gc.weighty=.8;

		frame.add(setMainPanel(), gc);
	...
	public JPanel setUserDetails() {
		...
		logout.addActionListener((event)->{
			int option =JOptionPane.showConfirmDialog(this.frame,"Are you sure?","Logout",JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);  
